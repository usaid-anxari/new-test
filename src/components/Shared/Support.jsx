...
const Support = () => {
  ...
  const categories = [
    ...
    { id: "technical", name: "Technical Issues", icon: ExclamationTriangleIcon },
  ];
  ...
  const faqs = [
    {
      ...
      answer: "Getting started is easy! Simply sign up for an account, choose your plan, and follow our step-by-step setup guide. We'll help you configure your first widget and start collecting testimonials within minutes.",
    ...
    },
    {
      ...
      answer: "TrueTestify supports video, audio, and text testimonials. You can collect reviews through our widget, QR codes, direct links, or by uploading existing testimonials. All formats are automatically optimized for display.",
    ...
    },
    {
      ...
      answer: "Copy the provided JavaScript code from your dashboard and paste it into your website's HTML. The widget will automatically appear and start collecting testimonials. We also provide iframe embed options for easier integration.",
      category: "widgets",
    ...
    },
    {
      ...
      answer: "Yes! You can customize colors, fonts, layout, and styling to match your brand. Our widget settings allow you to control everything from the widget position to the testimonial display format.",
      category: "widgets",
    ...
    },
    {
      ...
      answer: "Use our moderation dashboard to review, approve, or reject incoming testimonials. You can set up automatic approval rules, filter content, and manage testimonial display order. All testimonials are reviewed before going live.",
      category: "testimonials",
    ...
    },
    {
      ...
      answer: "Track widget views, testimonial submissions, conversion rates, and customer sentiment. Our analytics dashboard provides detailed reports on testimonial performance and their impact on your business.",
      category: "account",
    ...
    },
    {
      ...
      answer: "You can upgrade or downgrade your plan anytime from your billing dashboard. Changes take effect immediately, and we'll prorate any billing adjustments. Contact our support team if you need assistance with plan changes.",
      category: "account",
    ...
    },
    {
      ...
      answer: "Absolutely! We use enterprise-grade encryption and security measures to protect your data. We never share your information with third parties and comply with all major privacy regulations including GDPR and CCPA.",
      category: "technical",
    ...
    },
    {
      ...
      answer: "Yes! You can export testimonials in various formats including JSON, CSV, and HTML. We also offer direct integrations with popular platforms like WordPress, Shopify, and social media platforms.",
      category: "widgets",
    ...
    },
    {
      ...
      answer: "We'll notify you when you're approaching your limits. You can either upgrade your plan or we can work with you to optimize your usage. We never delete your data without warning.",
      category: "account",
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Get help with TrueTestify. Find answers, contact support, and learn how to make the most of our platform.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {supportChannels.map((channel, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300">
                <div className={`${channel.color} text-white p-4 rounded-full w-16 h-16 mx-auto mb-6 flex items-center justify-center`}>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <a href="#videos" className="text-blue-600 font-semibold hover:text-blue-700">
                Watch Videos →
              </a>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <a href="#best-practices" className="text-blue-600 font-semibold hover:text-blue-700">
                Learn More →
              </a>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
