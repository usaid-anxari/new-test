  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-1">
        ...
        <div className={`fixed inset-y-0 left-0 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 transition-transform duration-200 ease-in-out md:w-64 z-30 flex-shrink-0 md:flex`}>
      ...
      {/* Footer - Hidden on mobile dashboard */}
      <div className="hidden md:block">
        <Footer />
      </div>
    </div>
