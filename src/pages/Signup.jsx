...
// //   return (
// //     <div className="max-w-md mx-auto p-8 bg-white border border-gray-200 text-center">
// //       <h2 className="text-3xl font-bold text-gray-800 mb-6">Create Your TrueTestify Account</h2>
// //       <p className="text-gray-600 mb-8">
// //         Enter your business name to get started. You'll be redirected to connect your Shopify or WordPress store.
// //       </p>
...
// //         <button
// //           type="submit"
// //           className="w-full py-3 px-4 bg-blue-600 text-white font-bold tracking-wide hover:bg-blue-700 transition-colors"
// //         >
// //           Simulate Shopify OAuth Signup
// //         </button>
// //       </form>
